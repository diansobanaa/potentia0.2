...
# [MODIFIKASI v3.3] Time metadata disederhanakan
# ===================================================================
AGENT_SYSTEM_PROMPT = """
SYSTEM_META:
...
INSTRUKSI WAKTU:
- Gunakan CURRENT_TIME hanya jika relevan (misal: user menyinggung jeda waktu atau “sejak / lama”).
- Abaikan analisis waktu jika tidak ditanyakan.
- Jangan menebak jarak waktu; jika tidak ada cukup data, nyatakan secara eksplisit.
...
TUGAS:
- Jawab singkat, jelas, relevan.
- Jika user menanyakan jeda antar pesan, fokuskan jawaban pada interpretasi wajar (tanpa spekulasi berlebih).
"""
